...
#############
#
# 1 : go into a given box, all parameters depends on the temperature and rainfall
# 2 : go into a given box, all parameters depends on the temperature only
# 3 : go into a given box, all parameters are constant (average value)
# 4 : go into a given box, muA2 is rainfall-dependent, all other parameters are constant
#
# 6 : reduce the epidemiological risk, all parameters depends on the temperature and rainfall
# 7 : reduce the epidemiological risk, all parameters depends on the temperature only
# 8 : reduce the epidemiological risk, all parameters are constant (average value)
# 9 : reduce the epidemiological risk, muA2 is rainfall-dependent, all other parameters are constant
test_case = 4
...
#            print('(gama,muA1,muA2,muF,muM,phi,r)',gama_mean,muA1_mean,muA2_mean,muF_mean,mu_M_mean,phi_mean,r_mean)
            ...
            if test_case == 1:
                name_file = "box_mu2A_temp_rainfall_new"
            if test_case == 2:
                name_file = "box_mu2A_temp"
            if test_case == 3:
                name_file = "box_mu2A_param_mean"
            if test_case == 4:
                name_file = "Box_muA2_hydro_mean_Temp"
            if test_case == 6:
                name_file = "epidemio_muA2_temp_rainfall"
            if test_case == 7:
                name_file = "epidemio_muA2_temp"
            if test_case == 8:
                name_file = "epidemio_muA2_param_mean"
            if test_case == 9:
                name_file = "epidemio_muA2_rainfall_mean_Temp"
